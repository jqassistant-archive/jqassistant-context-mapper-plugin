...
NOTE:: This project has been archived and is no longer actively developed. It has been superseded by the https://github.com/jqassistant-plugin/jqassistant-context-mapper-plugin[jqassistant-context-mapper-plugin]
